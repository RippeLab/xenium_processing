...
if __name__ == "__main__":
    ...
    transcripts = pd.read_csv(transcript_file_name, sep = ",", 
        header = 0, usecols = ["x_location_px_ROI", "y_location_px_ROI", "feature_name"])

    transcripts = transcripts.rename(columns={"x_location_px_ROI":"x", "y_location_px_ROI":"y", "feature_name":"gene"})
